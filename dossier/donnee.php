                ...
                for (var val of data) {
                  ...
                  var td2=document.createElement('td');
                   ...
                   btn.value=val.id; //met l'id dans value du BUTTON
                    ...
                    btn.setAttribute("OnClick","bip("+btn.value+")");
...
//fin AfficheData
    ...
    function bip(valeur){
        ...
        $.get("traitement2.php",{myid:valeur},function(data) {

            AfficheData(); //aprs la suppression, on reaffiche ls donnes restantes
        });
    }
